<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
        <form role="form" action="{{route('admin.url_for_scrap.update')}}" method="POST">
          @csrf
          ...
          <div class="box-body">
            <div class="form-group {{$errors->has('site_id')? 'has-error' : ''}}">
              ...
              <select name="site_id" class="form-control">
                ...
                <option value="{{$site->id}}" @if(old('site_id')==$site->id || $url->site_id==$site->id){{'selected'}}@endif>{{$site->name}}</option>   
                @endforeach
              </select>
            ...
            <div class="form-group {{$errors->has('category_id')? 'has-error' : ''}}">
              ...
              <select name="category_id" class="form-control">
                ...
                <option value="{{$category->id}}" @if(old('category_id')==$category->id || $url->category_id==$category->id){{'selected'}}@endif>{{$category->name}}</option>   
                @endforeach
              </select>
            ...
            <div class="form-group {{$errors->has('url')? 'has-error':''}}">
              ...
              <input type="text" name='url' class="form-control" placeholder="العنوان" value="@if(old('url')){{old('url')}}@else{{$url->url}}@endif">
              @if($errors->has('url'))
              <span class="help-block">
              {{ $errors->first('url')}}
              </span>
            ...
            <div class="form-group {{$errors->has('num_pages')? 'has-error':''}}">
              ...
              <input type="number" name='num_pages' class="form-control" placeholder="عدد صفحات العنوان " value="@if(old('num_pages')){{old('num_pages')}}@else{{$url->num_pages}}@endif">
